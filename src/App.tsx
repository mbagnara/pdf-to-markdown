  ...
  return (
    <div className="app">
      <header className="app-header">
        ...
        <p>Everything is processed locally in your browser. Your file is never uploaded anywhere.</p>
      </header>

      <main className="app-main">
        {state.status === 'idle' && <PdfDropzone onFileSelected={convertFile} />}

        {state.status === 'error' && (
          <div className="state-stack">
            <ErrorMessage message={state.errorMessage ?? 'Unknown error.'} />
            <PdfDropzone onFileSelected={convertFile} />
          </div>
        )}
